...
- [Documentazione principale risoluzione conflitti git](../../../../project_docs/risoluzione_conflitti_git.md)
- [Documentazione dettagliata VideoEntry](../../../../project_docs/video_entry_conflict.md) 
