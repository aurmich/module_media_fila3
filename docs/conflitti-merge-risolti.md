...
- [Risoluzione Conflitti Git](../../../../project_docs/risoluzione_conflitti_git.md)
- [Report completo di intervento](../../../../project_docs/logs/conflict_resolution_report.md)
- [Gestione Git con Script Bash](../../../../project_docs/bashscripts/gestione_git.md)

## Collegamenti alle Risoluzioni Specifiche

- [Risoluzione conflitto VideoEntry](./risoluzione_conflitti_video_entry.md)
- [Risoluzione conflitto MediaConvertResource](../../../../project_docs/media_convert_resource_conflict.md)
...
Per approfondimenti generali sulle strategie di risoluzione dei conflitti, fare riferimento alla [documentazione centrale](../../../../project_docs/risoluzione_conflitti_git.md).

---

**Collegamento bidirezionale:** questo file è referenziato anche nella documentazione principale in `/project_docs/risoluzione_conflitti_git.md`.
...
Per dettagli completi sulla risoluzione di MediaConvertResource, vedere [documentazione dedicata](../../../../project_docs/media_convert_resource_conflict.md).
