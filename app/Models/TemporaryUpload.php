 ...
 * @method static TemporaryUpload|null first()
 * @method static \Illuminate\Database\Eloquent\Collection<int, TemporaryUpload> get()
 ...
 * @method static \Illuminate\Database\Eloquent\Builder<static>|TemporaryUpload where(string|\Closure $column, mixed $operator = null, mixed $value = null, string $boolean = 'and')
 * @method static \Illuminate\Database\Eloquent\Builder<static>|TemporaryUpload whereNotNull(string|\Illuminate\Contracts\Database\Query\Expression $columns)
